...
class SortDripVC: FormViewController {
    ...
    var sortKeyName :String = "dripTag_ForSortNamae"
    ...
    override func viewDidLoad() {
        ...
        if UserDefaults.standard.string(forKey: "dripSortKeyName") != nil {
            sortKeyName = UserDefaults.standard.string(forKey: "dripSortKeyName")!
            sortOrderBool = UserDefaults.standard.bool(forKey: "dripSortOrderBool")
        }
            ...
            if row.section === form[0] {
                ...
                switch (row.section as! SelectableSection<ListCheckRow<String>>).selectedRow()?.baseValue as! String {
                    ...
                    case "名前":
                        ...
                        sortKeyName = "dripTag_ForSortNamae"
                    case "変更日":
                        changeOrderValue(index:1)
                        sortKeyName = "dripEditedDate"
                    default:
                        print("Error")
                }
            }else{
    ...
    func sortButtonAction(button : UIButton){
        ...
        UserDefaults.standard.set(sortKeyName, forKey: "dripSortKeyName")
        UserDefaults.standard.set(sortOrderBool, forKey: "dripSortOrderBool")
