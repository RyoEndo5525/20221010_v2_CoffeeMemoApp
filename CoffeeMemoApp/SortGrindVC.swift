...
class SortGrindVC: FormViewController {
    ...
    var sortKeyName :String = "grindTag_ForSortNamae"
    ...
    override func viewDidLoad() {
        ...
        if UserDefaults.standard.string(forKey: "grindSortKeyName") != nil {
            sortKeyName = UserDefaults.standard.string(forKey: "grindSortKeyName")!
            sortOrderBool = UserDefaults.standard.bool(forKey: "grindSortOrderBool")
        }
            ...
            if row.section === form[0] {
                ...
                switch (row.section as! SelectableSection<ListCheckRow<String>>).selectedRow()?.baseValue as! String {
                    ...
                    case "名前":
                        ...
                        sortKeyName = "grindTag_ForSortNamae"
                    case "変更日":
                        changeOrderValue(index:1)
                        sortKeyName = "grindEditedDate"
                    default:
                        print("Error")
                }
            }else{
    ...
    func sortButtonAction(button : UIButton){
        ...
        UserDefaults.standard.set(sortKeyName, forKey: "grindSortKeyName")
        UserDefaults.standard.set(sortOrderBool, forKey: "grindSortOrderBool")
